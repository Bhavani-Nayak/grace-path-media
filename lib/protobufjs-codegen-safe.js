    ...
    function Codegen(formatStringOrScope) {
        ...
        if (typeof formatStringOrScope !== "string") {
            ...
            try {
                ...
                // Cloudflare Workers disallow Function() constructor (EvalError).
                // Fall back to a no-op function so protobuf reflection still works.
                if (err instanceof EvalError || (err && err.message && err.message.indexOf('disallowed') !== -1)) {
